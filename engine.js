...
import { DATA as FALLBACK } from './data/game-data.js?v=val15';
import { buildIndex } from './sheet-loader.js?v=val21';   // ★sheet-loader를 가리키는 곳은 **둘**이다 — 여기와 rl.dc.html의 import().
